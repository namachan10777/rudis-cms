...
export interface MarkdownReferenceMeta {}

export type ImageReference<S> = ObjectReference<ImageReferenceMeta, S>;

export type FileReference<S> = ObjectReference<FileReferenceMeta, S>;
export type MarkdownReference<S> = ObjectReference<MarkdownReferenceMeta, S>;
